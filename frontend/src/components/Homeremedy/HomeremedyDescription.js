    ...
    return <>
        ...
        <div className="rmm mt-3 mb-4">
            <div className="rmm d-flex align-items-start justify-content-evenly m-5 mt-2 p-3 flex-wrap">
                <div className="rmm d-flex flex-column" style={{ height: "400px", width: "600px" }}>
                    <img className="rmm shadow-lg border" alt="Homeremedy_image" src={state.imageUrl} style={{ height: "100%", width: '100%' }} />
