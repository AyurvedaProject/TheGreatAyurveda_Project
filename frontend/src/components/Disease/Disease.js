        ...
        <div className="d-flex flex-column container-fluid">
            ...
            <div id="textDiv" className="">
                ...
                {(homeremedies.length != 1) ?
                    <div className="container-fluid row rounded" style={{ background: "var(--white)" }}>
                        <div className=" p-2 py-1">
                            <h5 className="fw-bold my-2 text-center">HOME REMEDIES</h5>
                                    ...
                                    <div className="containerr-inline d-flex align-items-center mb-3">
                                        {homeremedies.map((remedy, index) => <div key={index}>
                                            <div id="link1" className="remede-box d-flex flex-column align-items-center justify-content-start" style={{ width: "270px" }}>
                                                <div className="remede-img m-1" style={{ height: "170px" }}><img src={remedy.imageUrl} onClick={() => ViewMore(remedy)} alt="..." style={{ height: "100%", width: '100%' }} /></div>
                                                <div className="remede-value h-100 m-1 d-flex flex-column justify-content-evenly align-items-center">
                                                    ...
                                                    <button id="link4" onClick={() => ViewMore(remedy)} className="btnn text-white m-2 p-1">View More</button>
                                                </div>
                                            </div>
                                        </div>)}
                                    </div>
                    ...
                    :
                    <div id="link1" class="card border-0 container">
                        <h5 className="fw-bold my-3 text-center">HOME REMEDIES</h5>
                        <div class="row no-gutters">
                            <div class="m-2 col-md-4">
                                <img src={homeremedies[0].imageUrl} class="card-img" alt="..." />
                                <p class="m-0 card-title text-center">{homeremedies[0].remedyName}</p>
                            </div>
                            <div class="col-md-7">
                                <div class="ms-2 mt-1 card-body p-0">
                                    <p class="m-0 card-title">Homeremedy {homeremedies[0].remedyName}</p>
                                    <p class="m- card-text"><small class="text-muted">{homeremedies[0].description}</small></p>
                                    <p class="m-0 card-text">Ingredients of {homeremedies[0].remedyName}</p>
                                    <p class="m- card-text"><small class="text-muted">{homeremedies[0].ingredients}</small></p>
                                    <p class="m-0 card-text">Instructions of {homeremedies[0].remedyName}</p>
                                    <p class="m- card-text"><small class="text-muted">{homeremedies[0].instructions}</small></p>
                                    <p class="m-0 card-text">caution of {homeremedies[0].remedyName}</p>
                                    <p class="m- card-text"><small class="text-muted">{homeremedies[0].caution}</small></p>
                                </div>
                            </div>
                        </div>
                    </div>}
                ...
                {(products.length != 1) ?
                                    ...
                                    <div className="containerr-inline d-flex align-items-center mb-3 mt-2">
                                        {products.map((product, index) => <div key={index}>
                                            <div className="remede-box d-flex flex-column align-items-center justify-content-center" style={{ width: "300px" }}>
                                                <div className="remede-img m-1" style={{ height: "180px" }}><img src={product.imageUrl} onClick={() => ProductView(product)} alt="..." style={{ height: "100%", width: '100%' }} /></div>
                                                <div id="link3" className="remede-value m-1 d-flex flex-column justify-content-center align-items-center">
                                                    ...
                                                    <div className="d-flex justify-content-evenly w-100">
                                                        <button className="btnn addtocart-btn text-white m-1" onClick={() => addToCart(product.id)}>Add To cart</button>
                    ...
                    :
                    <div id="link3" class="card border-0 container">
                        <h5 className="fw-bold my-3 text-center">MEDICINE</h5>
                        <div class="row no-gutters">
                            <div class="m-2 col-md-4">
                                <img src={products[0].imageUrl} class="card-img" alt="..." />
                                <p class="m-0 card-title text-center">{products[0].remedyName}</p>
                            </div>
                            <div class="col-md-7">
                                <div class="ms-2 mt-1 card-body p-0">
                                    <p class="card-title">{products[0].title}</p>
                                    <p class="card-title" style={{ color: "var(--green)" }}>{products.price} Rs [Inclusive of all Taxes]</p>
                                    <p class="card-text"><small class="text-muted">{products[0].description}</small></p>
                                    <div className="rmm gap-2 d-flex justify-content-start">
                                        ...
                                        <button className="btnn buynow-btn text-white "onClick={() => Buynow(products)}>Buy Now</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="carousel d-flex " style={{ transitionDuration: "0.5s", transform: `translateX(-${currentIndex * itemWidthyoga}px)` }}>
                                    {yoga.map((yogaa, index) => <div key={index}>
                                        <div className=" my-3 remede-box d-flex flex-column align-items-center justify-content-start" style={{ width: "270px" }}>
                                            <div className="remede-img m-1" style={{ height: "170px" }}><img src={yogaa.imageUrl} onClick={() => getStart(yogaa)} alt="..." style={{ height: "100%", width: '100%' }} /></div>
                                            ...
                                            <div className="remede-value m-1 d-flex flex-column justify-content-evenly h-100 align-items-center">
                                                ...
                                                <button className="fs-6 btnn text-white m-2 p-1" onClick={() => getStart(yogaa)}>Get Start</button>
                                            </div>
                                        </div>
                                    </div>)}
                                </div>
                                    ...
                                    {doctorConsult.map((doctor, index) =>
                                        <div key={index} className="carousel-item m-2 d-flex align-items-center justify-content-center ">
                                            <div className="remede-box d-flex flex-column align-items-center justify-content-start" style={{ width: "300px" }}>
                                                <div className="remede-img m-1 text-center" style={{ height: "200px" }}><img src={doctor.doctordetail.doctorImage} onClick={() => consult(doctor)} className="rounded-circl" alt="..." style={{ height: "100%", width: '100%' }} /></div>
                                                <FaPlay className="youtube-icon" size={30} />
